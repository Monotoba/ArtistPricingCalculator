...
public class OverheadActivity extends BaseActivity {
    ...
    public void onAdd(View view) {
        Log.d(TAG, "Passing '" + ItemContract.RECORD_TYPE + "' " + ItemContract.ITEM_TYPE_OVERHEAD + " to AddItemActivity.");
        Intent addIntent = new Intent(this, AddItemActivity.class)
                .putExtra(ItemContract.RECORD_TYPE, ItemContract.ITEM_TYPE_OVERHEAD);

        startActivity(addIntent);//, REQUEST_CODE);
        Toast.makeText(this, "onAdd was fired in OverheadActivity.class", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean showConfirm(final Item item) {
        mConfirmed = false;
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(OverheadActivity.this);
    ...
    public void onOverheadBack(View view) {
        finish();
    }
    ...
    public void updateUI() {
        ...
        // Get all items of the Overhead type
        itemList = mDB.getItemsByType(ItemContract.ITEM_TYPE_OVERHEAD);
        // Get the scrollview from the overhead layout
        LinearLayout containerView = (LinearLayout) findViewById(R.id.ll_overhead_container);
    ...
    public void onHelp() {
        Intent helpIntent = new Intent(this, OverheadHelpActivity.class);
