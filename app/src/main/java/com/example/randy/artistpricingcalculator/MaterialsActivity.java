...
public class MaterialsActivity extends BaseActivity {
    ...
    //public static final String MATERIALS_RECORD_TYPE = ItemContract.ITEM_TYPE_MATERIALS;
    private final int REQUEST_CODE = 336695;
    ...
    public void onAdd(View view) {
        Intent addIntent = new Intent(this, AddItemActivity.class)
                .putExtra(ItemContract.RECORD_TYPE, ItemContract.ITEM_TYPE_MATERIALS);

        startActivity(addIntent);//, REQUEST_CODE);
        Toast.makeText(this, "onAdd was fired in MaterialsActivity.class", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean showConfirm(final Item item) {
        mConfirmed = false;
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MaterialsActivity.this);
    ...
    public void onMaterialsBack(View view) {
        finish();
    }

    public void onNext(View view) {
        Intent packagingIntent = new Intent(this, PackagingActivity.class);
    ...
    public void updateUI() {
        ...
        // Get all items of the Materials type
        itemList = mDB.getItemsByType(ItemContract.ITEM_TYPE_MATERIALS);
        // Get the scrollview from the materials layout
        LinearLayout containerView = (LinearLayout) findViewById(R.id.ll_materials_container);
    ...
    public void onHelp() {
        Intent helpIntent = new Intent(this, MaterialsHelpActivity.class);
