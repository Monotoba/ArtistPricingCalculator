...
public class LaborActivity extends BaseActivity {
    ...
    //public static final String LABOR_RECORD_TYPE = ItemContract.ITEM_TYPE_LABOR;
    private final int REQUEST_CODE = 336697;
    ...
    public void onAdd(View view) {
        Intent addIntent = new Intent(this, AddItemActivity.class)
                .putExtra(ItemContract.RECORD_TYPE, ItemContract.ITEM_TYPE_LABOR);

        startActivity(addIntent);//, REQUEST_CODE);
        Toast.makeText(this, "onAdd was fired in LaborActivity.class", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean showConfirm(final Item item) {
        mConfirmed = false;
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(LaborActivity.this);
    ...
    public void onLaborBack(View view) {
        finish();
    }
...
//        startActivity(mainIntent);
    ...
    public void updateUI() {
        // Get all items of the Labor type
        itemList = mDB.getItemsByType(ItemContract.ITEM_TYPE_LABOR);
        // Get the scrollview from the labor layout
        LinearLayout containerView = (LinearLayout) findViewById(R.id.ll_labor_container);
    ...
    public void onHelp() {
        Intent helpIntent = new Intent(this, LaborHelpActivity.class);
