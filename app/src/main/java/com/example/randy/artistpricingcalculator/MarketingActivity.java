...
public class MarketingActivity extends BaseActivity {
    ...
    public void onAdd(View view) {
        Intent addIntent = new Intent(this, AddItemActivity.class)
                .putExtra(ItemContract.RECORD_TYPE, ItemContract.ITEM_TYPE_MARKETING);

        startActivity(addIntent);//, REQUEST_CODE);
        Toast.makeText(this, "onAdd was fired in MarketingActivity.class", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean showConfirm(final Item item) {
        mConfirmed = false;
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MarketingActivity.this);
    ...
    public void onMarketingBack(View view) {
        finish();
    }
...
//    }
    ...
    public void updateUI() {
        ...
        // Get all items of the Marketing type
        itemList = mDB.getItemsByType(ItemContract.ITEM_TYPE_MARKETING);
        // Get the scrollview from the marketing layout
        LinearLayout containerView = (LinearLayout) findViewById(R.id.ll_marketing_container);
    ...
    public void onHelp() {
        Intent helpIntent = new Intent(this, MarketingHelpActivity.class);
